...
execute as @a[gamemode=survival,tag=!trophy_one_twenty_one] if predicate qfe:ocean run function qfe:trophies/one_twenty_one
...
execute as @a[gamemode=survival,tag=!won,scores={score=1413..}] run function qfe:master/win