...
execute in overworld as @s[advancements={qfe:resources/nether_gold_ore=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_resources,tag=!nether_gold_ore] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 run scoreboard players add BlueTeam score 1
...
execute in overworld as @s[advancements={qfe:resources/nether_gold_ore=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_resources,tag=!nether_gold_ore] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score takeItems GameSetup matches 1 run clear @s nether_gold_ore 1
execute in overworld as @s[advancements={qfe:resources/nether_gold_ore=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_resources,tag=!nether_gold_ore] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 run tag @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0] add nether_gold_ore
...
execute in overworld as @s[advancements={qfe:resources/nether_gold_ore=true}] if score oneItemPerPerson GameSetup matches 1 if score takeItems GameSetup matches 1 run clear @s nether_gold_ore 1

execute in overworld as @s[advancements={qfe:resources/nether_gold_ore=true}] if score oneItemPerPerson GameSetup matches 1 run scoreboard players add @s score 1
execute at @s[advancements={qfe:resources/nether_gold_ore=true}] run playsound block.note_block.bit record @s ~ ~ ~ 1 1 1
