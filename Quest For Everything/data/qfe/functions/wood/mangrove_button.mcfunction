...
execute in overworld as @s[advancements={qfe:wood/mangrove_button=true},team=red] if entity @e[type=area_effect_cloud,name="Red Team",x=0,y=80,z=0,tag=!trophy_wood,tag=!mangrove_button] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 run scoreboard players add RedTeam score 1
...
execute in overworld as @s[advancements={qfe:wood/mangrove_button=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_wood,tag=!mangrove_button] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score takeItems GameSetup matches 1 run clear @s mangrove_button 1
execute in overworld as @s[advancements={qfe:wood/mangrove_button=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_wood,tag=!mangrove_button] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 run tag @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0] add mangrove_button
...
execute in overworld as @s[advancements={qfe:wood/mangrove_button=true}] if score oneItemPerPerson GameSetup matches 1 if score takeItems GameSetup matches 1 run clear @s mangrove_button 1

execute in overworld as @s[advancements={qfe:wood/mangrove_button=true}] if score oneItemPerPerson GameSetup matches 1 run scoreboard players add @s score 1
execute at @s[advancements={qfe:wood/mangrove_button=true}] run playsound block.note_block.bit record @s ~ ~ ~ 1 1 1
