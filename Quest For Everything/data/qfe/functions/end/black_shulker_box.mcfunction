...
execute in overworld as @s[advancements={qfe:end/black_shulker_box=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_end,tag=!black_shulker_box] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 run scoreboard players add BlueTeam score 1
...
execute in overworld as @s[advancements={qfe:end/black_shulker_box=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_end,tag=!black_shulker_box] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score takeItems GameSetup matches 1 run clear @s black_shulker_box 1
execute in overworld as @s[advancements={qfe:end/black_shulker_box=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_end,tag=!black_shulker_box] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 run tag @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0] add black_shulker_box
...
execute in overworld as @s[advancements={qfe:end/black_shulker_box=true}] if score oneItemPerPerson GameSetup matches 1 if score takeItems GameSetup matches 1 run clear @s black_shulker_box 1

execute in overworld as @s[advancements={qfe:end/black_shulker_box=true}] if score oneItemPerPerson GameSetup matches 1 run scoreboard players add @s score 1
execute at @s[advancements={qfe:end/black_shulker_box=true}] run playsound block.note_block.bit record @s ~ ~ ~ 1 1 1
