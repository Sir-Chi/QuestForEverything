...
execute in overworld as @s[advancements={qfe:manufactured/green_dye=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_manufactured,tag=!green_dye] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score takeItems GameSetup matches 1 run clear @s green_dye 1
execute in overworld as @s[advancements={qfe:manufactured/green_dye=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_manufactured,tag=!green_dye] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 run tag @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0] add green_dye
...
execute in overworld as @s[advancements={qfe:manufactured/green_dye=true}] if score oneItemPerPerson GameSetup matches 1 if score takeItems GameSetup matches 1 run clear @s green_dye 1

execute in overworld as @s[advancements={qfe:manufactured/green_dye=true}] if score oneItemPerPerson GameSetup matches 1 run scoreboard players add @s score 1
execute at @s[advancements={qfe:manufactured/green_dye=true}] run playsound block.note_block.bit record @s ~ ~ ~ 1 1 1
