...
execute at @e[tag=lobby_locator_bottom] positioned ~-10 ~ ~ positioned over motion_blocking_no_leaves run summon armor_stand ~ ~1 ~ {Invulnerable:1,Tags:["spawnPointLocator"]}
execute at @e[tag=spawnPointLocator] run setblock ~ ~-1 ~ dirt 
execute at @e[tag=spawnPointLocator] run setblock ~ ~-2 ~ dirt 
