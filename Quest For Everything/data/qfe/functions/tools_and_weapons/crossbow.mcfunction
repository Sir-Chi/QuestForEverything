...
execute in overworld as @s[advancements={qfe:tools_and_weapons/crossbow=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_tools_and_weapons,tag=!crossbow] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score takeItems GameSetup matches 1 run clear @s crossbow 1
...
execute in overworld as @s[advancements={qfe:tools_and_weapons/crossbow=true}] if score oneItemPerPerson GameSetup matches 1 if score takeItems GameSetup matches 1 run clear @s crossbow 1

execute in overworld as @s[advancements={qfe:tools_and_weapons/crossbow=true}] if score oneItemPerPerson GameSetup matches 1 run scoreboard players add @s score 1
execute at @s[advancements={qfe:tools_and_weapons/crossbow=true}] run playsound block.note_block.bit record @s ~ ~ ~ 1 1 1
