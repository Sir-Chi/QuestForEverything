...
execute in overworld as @s[advancements={qfe:resources/emerald_block=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_resources,tag=!emerald_block] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 run scoreboard players add BlueTeam score 1
...
execute in overworld as @s[advancements={qfe:resources/emerald_block=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_resources,tag=!emerald_block] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score takeItems GameSetup matches 1 run clear @s emerald_block 1
execute in overworld as @s[advancements={qfe:resources/emerald_block=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_resources,tag=!emerald_block] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 run tag @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0] add emerald_block
...
execute in overworld as @s[advancements={qfe:resources/emerald_block=true}] if score oneItemPerPerson GameSetup matches 1 if score takeItems GameSetup matches 1 run clear @s emerald_block 1

execute in overworld as @s[advancements={qfe:resources/emerald_block=true}] if score oneItemPerPerson GameSetup matches 1 run scoreboard players add @s score 1
execute at @s[advancements={qfe:resources/emerald_block=true}] run playsound block.note_block.bit record @s ~ ~ ~ 1 1 1
