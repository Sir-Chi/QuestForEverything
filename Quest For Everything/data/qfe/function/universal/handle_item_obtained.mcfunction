...
# $execute if score Teams GameSetup matches 1 run return run function qfe:universal/team_get {section:'$(section)', name:'$(name)'}

# Run solos code
$execute unless score Teams GameSetup matches 1 run function qfe:universal/solo_add_point {section:'$(section)'}
