...
execute at @e[tag=lobby_locator_bottom] if block ~ ~ ~ air run schedule function qfe:master/lobby/create_lobby 10t
execute at @e[tag=lobby_locator_bottom] unless block ~ ~ ~ air run function qfe:master/lobby/locate_lobby
