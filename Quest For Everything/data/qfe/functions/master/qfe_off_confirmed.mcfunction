...
execute as @a[scores={disableq4e=1..}] run advancement revoke @p[scores={disableq4e=1..}] from qfe:nature_and_loot/root
...
execute as @a[scores={disableq4e=1..}] run advancement revoke @p[scores={disableq4e=1..}] from qfe:tools_and_weapons/root
