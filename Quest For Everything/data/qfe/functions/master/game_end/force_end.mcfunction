...
scoreboard objectives remove nature_and_loot_score
...
scoreboard objectives remove tools_and_weapons_score
...
tag @e remove trophy_nature_and_loot
...
tag @e remove trophy_tools_and_weapons
