...
execute as @a[scores={teams=3}] run return run function qfe:master/join_mid_game/join_team {team:"green", team_name:"Green Team"}
execute as @a[scores={teams=4}] run return run function qfe:master/join_mid_game/join_team {team:"red", team_name:"Red Team"}
execute as @a[scores={teams=5}] run return run function qfe:master/join_mid_game/join_team {team:"purple", team_name:"Purple Team"}
execute as @a[scores={teams=6}] run return run function qfe:master/join_mid_game/join_team {team:"yellow", team_name:"Yellow Team"}
