...
tag @s remove heart_pottery_sherd
tag @s remove heartbreak_pottery_sherd
tag @s remove host_armor_trim_smithing_template
tag @s remove howl_pottery_sherd
tag @s remove ice
...
tag @s remove miner_pottery_sherd
tag @s remove moss_block
tag @s remove moss_carpet
tag @s remove mourner_pottery_sherd
tag @s remove mud
...
tag @s remove netherite_upgrade_smithing_template
...
tag @s remove peony
tag @s remove piglin_head
tag @s remove pink_petals
tag @s remove pink_tulip
tag @s remove plenty_pottery_sherd
tag @s remove podzol
tag @s remove poppy
tag @s remove prize_pottery_sherd
tag @s remove rabbit_hide
tag @s remove raiser_armor_trim_smithing_template
tag @s remove red_mushroom_block
tag @s remove red_mushroom
tag @s remove red_tulip
tag @s remove rib_armor_trim_smithing_template
...
tag @s remove sculk
tag @s remove sentry_armor_trim_smithing_template
tag @s remove shaper_armor_trim_smithing_template
tag @s remove sheaf_pottery_sherd
tag @s remove shelter_pottery_sherd
tag @s remove silence_armor_trim_smithing_template
tag @s remove skeleton_skull
tag @s remove skull_pottery_sherd
tag @s remove slime_ball
tag @s remove slime_block
tag @s remove small_dripleaf
tag @s remove sniffer_egg
tag @s remove snort_pottery_sherd
tag @s remove snout_armor_trim_smithing_template
tag @s remove snow_block
tag @s remove snow
tag @s remove snowball
tag @s remove spire_armor_trim_smithing_template
tag @s remove spore_blossom
tag @s remove string
tag @s remove sugar_cane
tag @s remove sunflower
tag @s remove tall_grass
tag @s remove tide_armor_trim_smithing_template
tag @s remove verdant_froglight
tag @s remove vex_armor_trim_smithing_template
tag @s remove vine
tag @s remove ward_armor_trim_smithing_template
tag @s remove wayfinder_armor_trim_smithing_template
tag @s remove white_tulip
tag @s remove wild_armor_trim_smithing_template
