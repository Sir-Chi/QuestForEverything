...
advancement grant @p only qfe:brewing/cap_brewing_18
advancement grant @p only qfe:brewing/cap_brewing_19

advancement grant @p only qfe:copper/root
advancement grant @p only qfe:copper/cap_copper_1
advancement grant @p only qfe:copper/cap_copper_2
advancement grant @p only qfe:copper/cap_copper_3
advancement grant @p only qfe:copper/cap_copper_4
advancement grant @p only qfe:copper/cap_copper_5
advancement grant @p only qfe:copper/cap_copper_6
advancement grant @p only qfe:copper/cap_copper_7
advancement grant @p only qfe:copper/cap_copper_8
advancement grant @p only qfe:copper/cap_copper_9
...
advancement grant @p only qfe:end/cap_end_5
advancement grant @p only qfe:end/cap_end_6

advancement grant @p only qfe:loot/root
advancement grant @p only qfe:loot/cap_loot_1
advancement grant @p only qfe:loot/cap_loot_2
advancement grant @p only qfe:loot/cap_loot_3
advancement grant @p only qfe:loot/cap_loot_4
advancement grant @p only qfe:loot/cap_loot_5
advancement grant @p only qfe:loot/cap_loot_6
advancement grant @p only qfe:loot/cap_loot_7
advancement grant @p only qfe:loot/cap_loot_8
advancement grant @p only qfe:loot/cap_loot_9
advancement grant @p only qfe:loot/cap_loot_10
advancement grant @p only qfe:loot/cap_loot_11
advancement grant @p only qfe:loot/cap_loot_12
advancement grant @p only qfe:loot/cap_loot_13
advancement grant @p only qfe:loot/cap_loot_14
advancement grant @p only qfe:loot/cap_loot_15
...
advancement grant @p only qfe:ocean/cap_ocean_9
...
advancement grant @p only qfe:stone/cap_stone_10
...
advancement grant @p only qfe:tools_and_combat/cap_tools_and_combat_2
advancement grant @p only qfe:tools_and_combat/cap_tools_and_combat_3
advancement grant @p only qfe:tools_and_combat/cap_tools_and_combat_4
advancement grant @p only qfe:tools_and_combat/cap_tools_and_combat_5
advancement grant @p only qfe:tools_and_combat/cap_tools_and_combat_6
advancement grant @p only qfe:tools_and_combat/cap_tools_and_combat_7
advancement grant @p only qfe:tools_and_combat/cap_tools_and_combat_8
