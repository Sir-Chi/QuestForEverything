...
execute in overworld as @s[advancements={qfe:nature_and_loot/big_dripleaf=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_nature_and_loot,tag=!big_dripleaf] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 run scoreboard players add BlueTeam score 1
...
execute in overworld as @s[advancements={qfe:nature_and_loot/big_dripleaf=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_nature_and_loot,tag=!big_dripleaf] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score takeItems GameSetup matches 1 run clear @s big_dripleaf 1
execute in overworld as @s[advancements={qfe:nature_and_loot/big_dripleaf=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_nature_and_loot,tag=!big_dripleaf] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 run tag @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0] add big_dripleaf
...
execute in overworld as @s[advancements={qfe:nature_and_loot/big_dripleaf=true}] if score oneItemPerPerson GameSetup matches 1 if score takeItems GameSetup matches 1 run clear @s big_dripleaf 1

execute in overworld as @s[advancements={qfe:nature_and_loot/big_dripleaf=true}] if score oneItemPerPerson GameSetup matches 1 run scoreboard players add @s score 1
execute at @s[advancements={qfe:nature_and_loot/big_dripleaf=true}] run playsound block.note_block.bit record @s ~ ~ ~ 1 1 1
