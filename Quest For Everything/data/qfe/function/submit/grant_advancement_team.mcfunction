...
# Incraese team marker's sync scores
...
$execute at @a[team=$(team)] run function qfe:submit/grant_advancement_criteria with entity @s data.itemCheck.foundItem