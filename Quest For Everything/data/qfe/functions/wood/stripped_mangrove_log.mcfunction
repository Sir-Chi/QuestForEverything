...
execute in overworld as @s[advancements={qfe:wood/stripped_mangrove_log=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_wood,tag=!stripped_mangrove_log] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 run scoreboard players add BlueTeam score 1
...
execute in overworld as @s[advancements={qfe:wood/stripped_mangrove_log=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_wood,tag=!stripped_mangrove_log] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score takeItems GameSetup matches 1 run clear @s stripped_mangrove_log 1
execute in overworld as @s[advancements={qfe:wood/stripped_mangrove_log=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_wood,tag=!stripped_mangrove_log] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 run tag @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0] add stripped_mangrove_log
...
execute in overworld as @s[advancements={qfe:wood/stripped_mangrove_log=true}] if score oneItemPerPerson GameSetup matches 1 if score takeItems GameSetup matches 1 run clear @s stripped_mangrove_log 1

execute in overworld as @s[advancements={qfe:wood/stripped_mangrove_log=true}] if score oneItemPerPerson GameSetup matches 1 run scoreboard players add @s score 1
execute at @s[advancements={qfe:wood/stripped_mangrove_log=true}] run playsound block.note_block.bit record @s ~ ~ ~ 1 1 1
