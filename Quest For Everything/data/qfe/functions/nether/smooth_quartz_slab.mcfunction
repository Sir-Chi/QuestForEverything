...
execute in overworld as @s[advancements={qfe:nether/smooth_quartz_slab=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_nether,tag=!smooth_quartz_slab] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 if score takeItems GameSetup matches 1 run clear @s smooth_quartz_slab 1
execute in overworld as @s[advancements={qfe:nether/smooth_quartz_slab=true},team=blue] if entity @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0,tag=!trophy_nether,tag=!smooth_quartz_slab] if score Teams GameSetup matches 1 if score oneItemPerPerson GameSetup matches 0 run tag @e[type=area_effect_cloud,name="Blue Team",x=0,y=80,z=0] add smooth_quartz_slab
...
execute in overworld as @s[advancements={qfe:nether/smooth_quartz_slab=true}] if score oneItemPerPerson GameSetup matches 1 if score takeItems GameSetup matches 1 run clear @s smooth_quartz_slab 1

execute in overworld as @s[advancements={qfe:nether/smooth_quartz_slab=true}] if score oneItemPerPerson GameSetup matches 1 run scoreboard players add @s score 1
execute at @s[advancements={qfe:nether/smooth_quartz_slab=true}] run playsound block.note_block.bit record @s ~ ~ ~ 1 1 1
